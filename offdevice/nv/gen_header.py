...
def render() -> str:
    ...
    lines = [
        ...
        " *",
        f" *     [NvHeader {spec.HEADER_SIZE} B][{spec.RECORDS_PER_PAGE} x NvRecord {spec.RECORD_SIZE} B]",
        " *",
    ...
    lines += [
        ...
        "   ~4 min for bring-up + fast captures; 90 s erases each page every ~6.2 h",
        "   => ~7 years to the rated minimum. */",
    ...
    lines += [
        ...
        _lock("page_fill_exact", "NV_HEADER_SIZE + NV_RECORDS_PER_PAGE * NV_RECORD_SIZE == NV_PAGE_SIZE"),
        "",
        "#endif /* NV_SPEC_H */",
        "",
    ]
